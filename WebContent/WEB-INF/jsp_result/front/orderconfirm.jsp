...
<script type="text/javascript">
	function submitorder(total){
		if(window.confirm("是否真的提交订单，提交后不可再修改订单信息！")){
			window.location.href="/ECommerce_SSM_001/order/orderSubmit?amount=" + total;
			return true;
		}
		return false;
	}
   ...
   <form action="" method="post">
    <h6>商品列表</h6>
        ...
        <div align="center" style="margin:8px auto;">
       		 <input type="button" value="提交订单" style="font-size:30px; width:150px; height:50px; background-color:#00FF00" onclick="submitorder(${total})"  />
    	</div> 
