...
<script type="text/javascript">
	...
	function  goOrderConfirm(){
		window.location.href="/ECommerce_SSM_001/cart/orderConfirm";
	}
	//继续购物
	function goContinue(){
		window.location.href="/ECommerce_SSM_001/before";
	}
	//清空
	function godelete(){
		if(window.confirm("真的清空购物车吗？")){
			window.location.href="/ECommerce_SSM_001/cart/clear";
			return true;
		}
		return false;
	}
	...
	function deleteAgoods(gno){
		if(window.confirm("真的删除该商品吗？")){
			window.location.href="/ECommerce_SSM_001/cart/deleteAgoods?id=" + gno;
			return true;
		}
		return false;
	}
				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="ce" items="${cartlist}"> 
						<tr>
							...
							<td align="center" bgcolor="#ffffff" width="185px"><input type="button"
								onclick="javaScript:deleteAgoods('${ce.id}')" class="f6" value="删除" />
							</td>
						</tr>
					</c:forEach>
					<tr>
